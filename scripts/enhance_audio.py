...
def enhance_audio(speaker_1_path, speaker_2_path, output_folder):
    ...
    report_progress(55) # Tahap 5: Memuat model enhancement
    ...
    report_progress(75) # Tahap 6: Meningkatkan kualitas suara Speaker 1
    ...
    report_progress(95) # Tahap 7: Meningkatkan kualitas suara Speaker 2
